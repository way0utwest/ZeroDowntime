...
( 'Ana Trujillo', 'Avda. de la Constituci�n 2222', 'M�xico D.F.', NULL, '05021' ),
( 'Antonio Moreno', 'Mataderos  2312', 'M�xico D.F.', NULL, '05023' ),
( 'Thomas Hardy', '120 Hanover Sq.', 'Londo', NULL, 'WA1 1DP' ),
( 'Christina Berglund', 'Berguvsv�gen  8', 'Lule�', NULL, 'S-958 22' ),
( 'Hanna Moos', 'Forsterstr. 57', 'Mannheim', NULL, '68306' ),
( 'Fr�d�rique Citeaux', '24, place Kl�ber', 'Strasbourg', NULL, '67000' ),
( 'Mart�n Sommer', 'C/ Araquil, 67', 'Madrid', NULL, '28023' ),
...
( 'Francisco Chang', 'Sierras de Granada 9993', 'M�xico D.F.', NULL, '05022' ),
( 'Yang Wang', 'Hauptstr. 29', 'Ber', NULL, '3012' ),
( 'Pedro Afonso', 'Av. dos Lus�adas, 23', 'Sao Paulo', 'SP', '05432-043' ),
